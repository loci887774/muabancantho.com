...
CREATE DATABASE IF NOT EXISTS `salomon` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `salomon`;
...
INSERT INTO `sanpham` (`sp_ma`, `sp_ten`, `sp_gia`, `sp_giacu`, `sp_mota_ngan`, `sp_mota_chitiet`, `sp_ngaycapnhat`, `sp_soluong`, `lsp_ma`, `nsx_ma`, `km_ma`) VALUES
	...
	(7, 'Samsung Galaxy Tab 2 7.0', 7500000.00, 7950000.00, 'MÃ¡y tÃ­nh báº£ng Samsung Galaxy Tab 2 7.0 ', 'Mï¿½n hï¿½nh 7 inch C?m ?ng ?i?n dung,?a ?i?m', '2020-01-28 10:42:08', 13, 1, 2, NULL),
	(8, 'adasd', 5000000.00, 5000000.00, 'Ã¡dsad', 'sadassad', '2013-01-28 10:37:52', 12, 1, 1, NULL);
